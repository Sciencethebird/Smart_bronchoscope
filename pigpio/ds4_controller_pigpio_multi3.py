...
m1 = motor('m1', 17, 27, msc)
m2 = motor('m2', 5, 6, msc)
m3 = motor('m3', 19, 26, msc)
#m1.set_encoder(20, 21)
#m2.set_encoder(26, 19)

pi = pigpio.pi()
pi.set_mode(24, pigpio.OUTPUT)  # small stepper on/off
pi.set_mode(23, pigpio.OUTPUT) # small stepper dir

stepper_on = [False, False]
pygame.init()
        ...
        for i in range( buttons ):
            ...
            if i == 7:
                if button == 1:
                    ...
                    stepper_on[1] = False
            if stepper_on[0] == False and stepper_on[1]==False:
                pi.write(24, 0)
                pi.write(23, 0)
